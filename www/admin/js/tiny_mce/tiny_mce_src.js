...
(function() {
	...
	tinymce.create('tinymce.util.URI', {
		URI : function(u, s) {
			...
			if (!/^[\w-]*:?\/\//.test(u)) {
				ADRESSE = s.base_uri ? s.base_uri.path : new tinymce.util.URI(location.href).directory;
				u = ((s.base_uri && s.base_uri.protocol) || 'http') + '://mce_host' + t.toAbsPath(ADRESSE, u);
			}
	...
	tinymce.create('tinymce.Editor', {
		Editor : function(id, s) {
			...
			t.settings = s = extend({
				...
				popup_css : '',
				plugins : '',
				document_ADRESSE : tinymce.documentBaseURL,
			...
			t.documentBaseURI = new tinymce.util.URI(s.document_ADRESSE || tinymce.documentBaseURL, {
		...
		init : function() {
			...
			if (s.document_ADRESSE != tinymce.documentBaseURL)
