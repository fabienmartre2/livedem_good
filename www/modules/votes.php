...
$liste_propositions = Proposition::selectPropositions(1, 0, array('proposition_statut >= 4'), 'IF(proposition_statut="4", -1, proposition_statut) ASC, proposition_date DESC');
$smarty->assign('liste_propositions', $liste_propositions);
$smarty->assign('statut', 4);
