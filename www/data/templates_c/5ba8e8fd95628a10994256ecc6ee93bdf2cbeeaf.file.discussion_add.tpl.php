<?php /* Smarty version Smarty-3.1.14, created on 2014-12-08 11:29:30
         compiled from "/home/dev/www/livedem/templates/discussion_add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:142478337154857d8a9cb964-21472028%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5ba8e8fd95628a10994256ecc6ee93bdf2cbeeaf' => 
    array (
      0 => '/home/dev/www/livedem/templates/discussion_add.tpl',
      1 => 1417529522,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '142478337154857d8a9cb964-21472028',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54857d8ac3de25_71017149',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54857d8ac3de25_71017149')) {function content_54857d8ac3de25_71017149($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
discussions.html">Discussions</a>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['success']->value)&&$_smarty_tpl->tpl_vars['success']->value){?>
		<div class="success">
			Votre discussion a été créée.<br />
		</div>
	<?php }else{ ?>
...
<?php }?>" /></td></tr>
					<tr><td class="form_design_titre">Description :</td><td><textarea name="sujet" style="height:300px;"><?php if (isset($_POST['sujet'])){?><?php echo stripslashes($_POST['sujet']);?>
<?php }?></textarea></td></tr>
				</table>
			</div>
			...
			<div style="text-align:center;">
				...
				<button type="submit" class="design"><div class="data">Créer</div></button>
			</div>
		</form>
	<?php }?>
	<div class="clear"></div>
