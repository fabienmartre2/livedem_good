<?php /* Smarty version Smarty-3.1.14, created on 2014-12-06 14:11:27
         compiled from "/home/dev/www/livedem/templates/proposition_add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4755727585483007faf45f1-77242114%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '864438b393ae799623a5bb1b56ddb23efc5ca6e3' => 
    array (
      0 => '/home/dev/www/livedem/templates/proposition_add.tpl',
      1 => 1417539299,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '4755727585483007faf45f1-77242114',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5483007fe58849_16932143',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5483007fe58849_16932143')) {function content_5483007fe58849_16932143($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/dev/www/livedem/lib/Smarty/plugins/function.html_options.php';
...
propositions.html">Propositions</a>
	> <a href="<?php echo $_smarty_tpl->tpl_vars['ADRESSE']->value;?>
proposition_add.html">Soumettre une proposition</a>
</div>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['success']->value)&&$_smarty_tpl->tpl_vars['success']->value){?>
		<div class="success">
			...
			Elle sera visible une fois approuvé par 2 citoyens référents.
		</div>
	<?php }else{ ?>
...
<?php }?></textarea></td></tr>
					...
					<?php }?></td></tr>
					<tr><td class="form_design_titre">Niveau Electoral* :</td><td>
					<?php if (isset($_POST['niveauId'])){?>
						<?php echo smarty_function_html_options(array('name'=>'niveauId','options'=>Niveau::selectArray(),'selected'=>$_POST['niveauId']),$_smarty_tpl);?>

					<?php }else{ ?>
						<?php echo smarty_function_html_options(array('name'=>'niveauId','options'=>Niveau::selectArray()),$_smarty_tpl);?>

					<?php }?></td></tr>
					<tr><td class="form_design_titre">Coût :</td><td><input type="text" name="cout" value="<?php if (isset($_POST['cout'])){?><?php echo stripslashes($_POST['cout']);?>
<?php }?>" /></td></tr>
					<tr><td class="form_design_titre">Zone géographique impactée* :</td><td><input type="text" name="zone" value="<?php if (isset($_POST['zone'])){?><?php echo stripslashes($_POST['zone']);?>
<?php }?>" /></td></tr>
					<tr><td class="form_design_titre">Source de financement* :</td><td><input type="text" name="financement" value="<?php if (isset($_POST['financement'])){?><?php echo stripslashes($_POST['financement']);?>
<?php }?>" /></td></tr>
					<tr><td class="form_design_titre">Population impactée* :</td><td><input type="text" name="impact" value="<?php if (isset($_POST['impact'])){?><?php echo stripslashes($_POST['impact']);?>
<?php }?>" /></td></tr>
					<tr><td class="form_design_titre">Délai de mise en place* :</td><td><input type="text" name="delai" value="<?php if (isset($_POST['delai'])){?><?php echo stripslashes($_POST['delai']);?>
<?php }?>" /></td></tr>
					<tr><td class="form_design_titre">Période d'application* :</td><td><input type="text" name="periode" value="<?php if (isset($_POST['periode'])){?><?php echo stripslashes($_POST['periode']);?>
<?php }?>" /></td></tr>
			...
			<div style="text-align:center;">
				<label style="font-size:14px;"><input type="checkbox" name="verif" value="1" /> J'ai vérifié que cette proposition n'existe pas déjà.</label>
				<br /><br />
