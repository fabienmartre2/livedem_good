<?php /* Smarty version Smarty-3.1.14, created on 2017-01-30 11:47:53
         compiled from "/home/livedem/www/templates/sondage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:773737959588f19d93d8ca7-04072123%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6f165e553f2f9c400e98393d75db8b51c3300232' => 
    array (
      0 => '/home/livedem/www/templates/sondage.tpl',
      1 => 1449591567,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '773737959588f19d93d8ca7-04072123',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_588f19d9532fd9_64055692',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_588f19d9532fd9_64055692')) {function content_588f19d9532fd9_64055692($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
">Accueil</a>
	> <a href="<?php echo $_smarty_tpl->tpl_vars['ADRESSE']->value;?>
sondages.html">Sondages</a>
	> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sondage']->value->getQuestion(), ENT_QUOTES, 'UTF-8', true);?>
	...
	<h1 class="titre"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sondage']->value->getQuestion(), ENT_QUOTES, 'UTF-8', true);?>
</h1>

	<?php if ($_smarty_tpl->tpl_vars['deja_vote']->value==0){?>
	<div style="text-align:center;">
		<form action="<?php echo $_smarty_tpl->tpl_vars['ADRESSE']->value;?>
sondage/<?php echo $_smarty_tpl->tpl_vars['sondage']->value->getId();?>
.html" method="POST">
	...
	<div class="proposition">
		...
		<div class="proposition_menu" style="margin-left:230px;">
			...
			<div class="proposition_menu_contenu" style="color:#8e0000; text-align:center;">
				<?php echo $_smarty_tpl->tpl_vars['votes_1']->value;?>
 votes<br />
				<?php if (($_smarty_tpl->tpl_vars['votes_1']->value+$_smarty_tpl->tpl_vars['votes_2']->value+$_smarty_tpl->tpl_vars['votes_3']->value)==0){?>
					0%
				<?php }else{ ?>
					<?php echo ($_smarty_tpl->tpl_vars['votes_1']->value/($_smarty_tpl->tpl_vars['votes_1']->value+$_smarty_tpl->tpl_vars['votes_2']->value+$_smarty_tpl->tpl_vars['votes_3']->value))*sprintf("%d",100);?>
 %
				<?php }?>
			</div>
		</div>
		...
		<div class="proposition_menu">
			...
			<div class="proposition_menu_contenu" style="color:#034066; text-align:center;">
				<?php echo $_smarty_tpl->tpl_vars['votes_2']->value;?>
 votes<br />
				<?php if (($_smarty_tpl->tpl_vars['votes_1']->value+$_smarty_tpl->tpl_vars['votes_2']->value+$_smarty_tpl->tpl_vars['votes_3']->value)==0){?>
					0%
				<?php }else{ ?>
					<?php echo ($_smarty_tpl->tpl_vars['votes_2']->value/($_smarty_tpl->tpl_vars['votes_1']->value+$_smarty_tpl->tpl_vars['votes_2']->value+$_smarty_tpl->tpl_vars['votes_3']->value))*sprintf("%d",100);?>
 %
				<?php }?>
			</div>
		</div>
