<?php /* Smarty version Smarty-3.1.14, created on 2019-06-04 20:02:17
         compiled from "/home/livedem/www/templates/pass.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11301573875cf6b229900e23-82536275%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dac18a4adf7f2f09800844271715a81e7fe583ab' => 
    array (
      0 => '/home/livedem/www/templates/pass.tpl',
      1 => 1450284908,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '11301573875cf6b229900e23-82536275',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf6b2299f5472_03288569',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf6b2299f5472_03288569')) {function content_5cf6b2299f5472_03288569($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
" method="POST" enctype="multipart/form-data" class="form-horizontal" name="inscription" id="inscriptionform">
				<div class="form-group <?php if (in_array('email',$_smarty_tpl->tpl_vars['errorChamps']->value)){?>has-error<?php }?>" >
					...
					<div class="col-sm-8">
						<input type="text" name="email" id="email" placeholder="E-Mail" value="<?php if (isset($_POST['email'])){?><?php echo $_POST['email'];?>
<?php }?>" class="form-control"/>
					</div>
				</div>
				<div class="form-group <?php if (in_array('nom',$_smarty_tpl->tpl_vars['errorChamps']->value)){?>has-error<?php }?>" >
					...
					<div class="col-sm-8">
						<img src="<?php echo $_smarty_tpl->tpl_vars['ADRESSE']->value;?>
modules/anti_spam.php?name=contact&strlen=6" alt="anti-flood" align="middle" style="margin-bottom:2px;"/>
					</div>
				</div>
				<div class="form-group <?php if (in_array('spam',$_smarty_tpl->tpl_vars['errorChamps']->value)){?>has-error<?php }?>" >
					<label for="spam" class="col-sm-4 control-label">A recopier ci-contre * : </label>
					<div class="col-sm-8">
						<input type="text" name="spam" id="spam" placeholder="" value="<?php if (isset($_POST['spam'])){?><?php echo $_POST['spam'];?>
<?php }?>" class="form-control"/>
					</div>
				</div>
