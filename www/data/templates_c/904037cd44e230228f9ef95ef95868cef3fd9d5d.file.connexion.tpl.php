<?php /* Smarty version Smarty-3.1.14, created on 2014-12-09 08:53:27
         compiled from "/home/dev/www/livedem/templates/connexion.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20604887175486aa77863e56-08862406%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '904037cd44e230228f9ef95ef95868cef3fd9d5d' => 
    array (
      0 => '/home/dev/www/livedem/templates/connexion.tpl',
      1 => 1417612962,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '20604887175486aa77863e56-08862406',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5486aa77a60965_17945613',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5486aa77a60965_17945613')) {function content_5486aa77a60965_17945613($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
" method="POST">
			<div class="form_design">
				<table style="margin:auto;">
					<tr><td>E-mail : </td><td><input type="text" name="email" value="E-mail" onfocus="if(this.value=='E-mail'){this.value=''}" onblur="if(this.value==''){this.value='E-mail'}" /></td></tr>
					<tr><td>Mot de passe : </td><td><input type="password" name="password" value="Pass" onfocus="if(this.value=='Pass'){this.value=''}" onblur="if(this.value==''){this.value='Pass'}" /></td></tr>
				</table>
			</div>
