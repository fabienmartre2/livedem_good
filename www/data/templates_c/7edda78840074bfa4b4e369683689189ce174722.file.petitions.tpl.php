<?php /* Smarty version Smarty-3.1.14, created on 2019-06-05 04:32:03
         compiled from "/home/livedem/www/templates/petitions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4757607225cf729a3d284f7-19473470%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7edda78840074bfa4b4e369683689189ce174722' => 
    array (
      0 => '/home/livedem/www/templates/petitions.tpl',
      1 => 1449843710,
      2 => 'file',
    ),
    ...
    '10dcc2016fdebd3938be37d8da6929ff25a905b0' => 
    array (
      0 => '/home/livedem/www/templates/petitions_view.tpl',
      1 => 1451320065,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4757607225cf729a3d284f7-19473470',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf729a3ec5191_97124228',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf729a3ec5191_97124228')) {function content_5cf729a3ec5191_97124228($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('search_bar.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '4757607225cf729a3d284f7-19473470');
content_5cf729a3e164d0_08046153($_smarty_tpl);
...
<div class="proposition_menu">
	...
	<div class="proposition_menu_contenu" style="color:#8e0000;">
		<a href="<?php echo $_smarty_tpl->tpl_vars['ADRESSE']->value;?>
petition_add.html">Créer une nouvelle pétition</a>
	</div>
</div>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('petitions_view.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('petition'=>$_smarty_tpl->tpl_vars['petition']->value), 0, '4757607225cf729a3d284f7-19473470');
content_5cf729a3e652d5_27326295($_smarty_tpl);
...
<?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2019-06-05 04:32:03
         compiled from "/home/livedem/www/templates/search_bar.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5cf729a3e164d0_08046153')) {function content_5cf729a3e164d0_08046153($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/livedem/www/lib/Smarty/plugins/function.html_options.php';
...
</div><?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2019-06-05 04:32:03
         compiled from "/home/livedem/www/templates/petitions_view.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5cf729a3e652d5_27326295')) {function content_5cf729a3e652d5_27326295($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/livedem/www/lib/Smarty/plugins/modifier.date_format.php';
...
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['petition']->value->getTitre(), ENT_QUOTES, 'UTF-8', true);?>
" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['petition']->value->getTitre(), ENT_QUOTES, 'UTF-8', true);?>
" />
	</div>
	<div class="liste_proposition_description">
		<h3><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['petition']->value->getTitre(), ENT_QUOTES, 'UTF-8', true);?>
</h3>
...
, le <?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['petition']->value->getDate(),"%d/%m/%y");?>
 par <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['petition']->value->getUtilisateur()->getPseudo(), ENT_QUOTES, 'UTF-8', true);?>
</div>
		<div class="liste_proposition_description_texte">
			<?php echo htmlspecialchars(smarty_modifier_truncate($_smarty_tpl->tpl_vars['petition']->value->getDescription(),150), ENT_QUOTES, 'UTF-8', true);?>
<br />
			<?php $_smarty_tpl->tpl_vars['petitionId'] = new Smarty_variable($_smarty_tpl->tpl_vars['petition']->value->getId(), null, 0);?>
			<div class="clear" style="height:5px;"></div>
			<i class="glyphicon glyphicon-leaf"></i> Il y a actuellement <b><?php echo Signature::getNbSignatures(array("petition_id = ".((string)$_smarty_tpl->tpl_vars['petitionId']->value)));?>
</b> signataire<?php if (Signature::getNbSignatures(array("petition_id = ".((string)$_smarty_tpl->tpl_vars['petitionId']->value)))>1){?>s<?php }?>
		</div>
...
images/btn_voir_petition.png" /></a>
		</div>
	</div>
	<div class="clear"></div>
</div>
