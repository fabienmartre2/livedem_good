<?php /* Smarty version Smarty-3.1.14, created on 2014-12-15 22:21:50
         compiled from "/home/livedem/www/dev/templates/inscription.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1166749119548f50ee597af5-20847857%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b0545201923baeb8ac0658603bbc2ae859dfab9d' => 
    array (
      0 => '/home/livedem/www/dev/templates/inscription.tpl',
      1 => 1418120420,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1166749119548f50ee597af5-20847857',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_548f50ee70aca8_12143078',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_548f50ee70aca8_12143078')) {function content_548f50ee70aca8_12143078($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_select_date')) include '/home/livedem/www/dev/lib/Smarty/plugins/function.html_select_date.php';
...
">Accueil</a>
	> <a href="<?php echo $_smarty_tpl->tpl_vars['ADRESSE']->value;?>
inscription.html">Inscription</a>
</div>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['success']->value)&&$_smarty_tpl->tpl_vars['success']->value){?>
		<div class="success">
			...
			Pour activer votre compte, valider votre adresse e-mail
		</div>
	<?php }else{ ?>
		...
		<?php }?>
		<form name="inscription" action="<?php echo $_smarty_tpl->tpl_vars['ADRESSE']->value;?>
inscription.html" method="POST">
			<div class="form_design">
				<table style="margin:auto;">
					<tr><td class="form_design_titre">Pseudo* :</td><td><input type="text" name="pseudo" value="<?php if (isset($_POST['pseudo'])){?><?php echo stripslashes($_POST['pseudo']);?>
<?php }?>" /></td></tr>
...
<?php }?>" /></td></tr>
					...
					<tr><td class="form_design_titre">Adresse :</td><td><input type="text" name="adresse" value="<?php if (isset($_POST['adresse'])){?><?php echo stripslashes($_POST['adresse']);?>
<?php }?>" /></td></tr>
					<tr><td class="form_design_titre">Code posta*l :</td><td><input type="text" name="ville_codepostal" id="codepostal" value="<?php if (isset($_POST['ville_codepostal'])){?><?php echo $_POST['ville_codepostal'];?>
<?php }?>" /></td></tr>
					<tr><td class="form_design_titre">Ville* :</td><td><select name="villeId" id="villeId"><option value="<?php if (isset($_POST['villeId'])){?><?php echo $_POST['villeId'];?>
<?php }?>"><?php if (isset($_POST['villeId'])&&!empty($_POST['villeId'])){?><?php echo Ville::selectVille($_POST['villeId'])->getNom();?>
<?php }else{ ?>Choisissez ...<?php }?></option></select></td></tr>
...
<?php }?>" /></td></tr>
			...
			<div style="text-align:center;">
				<label style="font-size:14px;"><input type="checkbox" name="cgu" value="1" /> Je m'engage à respecter les conditions générales d'utilisation du site.</label>
				<br /><br />
				<input type="hidden" name="send" value="1" />
				<button type="submit" class="design"><div class="data">Inscription</div></button>
			</div>
			<div class="clear" style="height:20px;"></div>
