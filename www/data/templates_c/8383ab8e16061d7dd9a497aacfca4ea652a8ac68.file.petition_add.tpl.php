<?php /* Smarty version Smarty-3.1.14, created on 2019-05-31 01:21:57
         compiled from "/home/livedem/www/templates/petition_add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1635518385cf06595441221-85679554%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8383ab8e16061d7dd9a497aacfca4ea652a8ac68' => 
    array (
      0 => '/home/livedem/www/templates/petition_add.tpl',
      1 => 1450284908,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1635518385cf06595441221-85679554',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf06595594e84_23192107',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf06595594e84_23192107')) {function content_5cf06595594e84_23192107($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/livedem/www/lib/Smarty/plugins/function.html_options.php';
...
">Accueil</a></li>
	<li><a href="<?php echo $_smarty_tpl->tpl_vars['ADRESSE']->value;?>
petitions.html">Discussions</a></li>
...
" method="POST" enctype="multipart/form-data" class="form-horizontal" name="inscription" id="inscriptionform">
				<div class="form-group <?php if (in_array('titre',$_smarty_tpl->tpl_vars['errorChamps']->value)){?>has-error<?php }?>" >
					...
					<div class="col-sm-8">
						<input type="text" name="titre" id="titre" placeholder="Titre de votre pétition" value="<?php if (isset($_POST['titre'])){?><?php echo $_POST['titre'];?>
<?php }?>" class="form-control"/>
					</div>
				</div>
				<div class="form-group <?php if (in_array('description',$_smarty_tpl->tpl_vars['errorChamps']->value)){?>has-error<?php }?>" >
					...
					<div class="col-sm-8">
						<textarea type="text" name="description" id="description" placeholder="Description l'objet de votre pétition" class="form-control" rows="10"><?php if (isset($_POST['description'])){?><?php echo $_POST['description'];?>
<?php }?></textarea>
					</div>
				</div>
				...
				<div class="form-group <?php if (in_array('vignette',$_smarty_tpl->tpl_vars['errorChamps']->value)){?>has-error<?php }?>" >
