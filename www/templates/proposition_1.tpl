...
<div class="ariane">
	...
	{if $statut < $proposition->getStatut()}
		...
		<a href="{$ADRESSE}proposition/{$proposition->getId()}.html">Cliquez-ici pour y accéder</a></div>
	{/if}
			...
			<div class="proposition_description">
				...
				<div style="margin-top:3px;">
						<form action="{$smarty.server.REQUEST_URI}" method="POST" style="float:right; margin-right:25px;">
							...
							<input type="image" src="{$ADRESSE}images/btn_valide_pour.png" />
						</form>
						<form action="{$smarty.server.REQUEST_URI}" method="POST" style="float:right; margin-right:25px;">
							<input type="hidden" name="vote" value="2" />
							<input type="image" src="{$ADRESSE}images/btn_valide_contre.png" />
						</form>
						<div class="clear"></div>
					</div>
					<div class="clear"></div>
